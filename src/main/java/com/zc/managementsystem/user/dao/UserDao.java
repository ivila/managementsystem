...
public class UserDao {
    ...
    private static final String SELECT_BY_USER_NAME_SQL = "SELECT * FROM users WHERE username = ?";

    public User getUserByUserName(String userName) {
        User user = new User();
        jdbcTemplate.query(SELECT_BY_USER_NAME_SQL, new Object[]{userName}, new RowCallbackHandler() {
